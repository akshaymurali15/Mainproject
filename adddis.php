...
include 'db.php';
 ...
 if(isset($_POST['submit']))
 {
    ...
    $log = mysqli_query($conn, "INSERT INTO `login`(`username`, `password`, `Role`,`Status`) VALUES ('$unm','$passw','distributor','ACCEPTED')" );
    $roleID=mysqli_insert_id($conn);
    mysqli_query($conn,"INSERT INTO `distributor`(`Name`, `Mobile`, `Email`, `Login_id`, `Address`, `License_no`, `Upload_License`) VALUES ('$name','$phone','$email','$roleID','$ad','$lic','$fileName')");

        echo "<script>alert('Added');</script>";
      }
      header("location: adminviewdis.php");
    }
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Add Distributor</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
