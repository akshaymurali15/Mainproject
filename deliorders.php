...
session_start();
$uid = $_SESSION['UserID'];
$resulttt=mysqli_query($conn,"SELECT * FROM `user-order` join user on user.Login_id=`user-order`.`User_id` WHERE deliboy_id='$uid' and Status !='Delivered'");
 ?>
 <!DOCTYPE html>
<html lang="en">
<head>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">ORDER TO DELIVER</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><a href="deliorddet.php?id=<?php echo $row['User_Order_id'];?>"><input type="submit" value="DETAILS"></a></td>
                 </tr>
                  <?php } ?>
                  </tbody>
                  <tfoot>
