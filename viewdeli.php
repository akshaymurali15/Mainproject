              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><img src="profile/<?php echo $row['Aadhaar_Upload'];
                    $ell= $row['Email'];?>" width="70" height="80"></td>
                    <td> <a href="editdeli.php?b_id=<?php echo $row['Login_id'];?>">
                        <input type="button" class="btn btn-success" value="Edit details"></a>
                        <?php if ($row['Status'] == 'BLOCKED') { ?>
                    <a href="en1dis1person.php?a_id=<?php echo $row['Login_id'];?>&&ss=BLOCKED&&ell=<?php echo $ell;?>"><Button type="submit" class="btn btn-primary">ENABLE</Button></a>
                    <?php } else { ?>  
                    <a href="en2dis2person.php?a_id=<?php echo $row['Login_id'];?>&&ss=ACCEPTED && esl=<?php echo $ell;?>"><Button type="submit" class="btn btn-primary">DISABLE</Button></a>
                    <?php } ?>
