<?php 
include 'db.php';
$resulttt=mysqli_query($conn,"SELECT * FROM `user-order` join user on user.Login_id=`user-order`.`User_id` WHERE `user-order`.Status IN ('Delivered','Shipped')");
 ?>
 <!DOCTYPE html>
<html lang="en">
<head>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><a href="dorderdet.php?id=<?php echo $row['User_Order_id'];?>"><input type="submit" value="DETAILS"></a></td>
                 </tr>
                  <?php } ?>
                  </tbody>
                  <tfoot>
