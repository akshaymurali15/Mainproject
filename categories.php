...
$result=mysqli_query($conn,"SELECT * FROM `book-type`");
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td> <a href="cate.php?b_id=<?php echo $row['Type_id'];?>">
                      <input type="button" class="btn btn-primary" style="margin-left:20px;" value="BOOKS">
                      </a></td>
                  </tr>
                  <?php } ?>
                  </tbody>
