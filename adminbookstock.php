<?php 
include 'db.php';
$result=mysqli_query($conn,"SELECT * FROM `books` JOIN `tbl_stock` ON `tbl_stock`.Book_id =`books`.Book_id JOIN `dealer` ON dealer.Dealer_id = tbl_stock.dealer_id where Status='YES'");
 ?>
 <!DOCTYPE html>
<html lang="en">
<head>
