...
$uid=$_SESSION['UserID'];
 ...
 if(isset($_POST['submit']))
 {
   ...
   $sq= mysqli_query($conn,"INSERT INTO `complaint`(`Content`,`Login_id`,`comp_stat`) VALUES ('$name','$uid',0)");
if($sq){
  ...
  <div class="content-wrapper">
    ...
    <form method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="exampleInputName1" placeholder="Enter complaint" style="height:200px;" required></textarea>
                  </div>
