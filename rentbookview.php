<?php 
include 'db.php';
$result=mysqli_query($conn,"SELECT * FROM `rentedbook` JOIN `book-type` ON `book-type`.Type_id =`rentedbook`.Type_id");
 ?>
 <!DOCTYPE html>
<html lang="en">
<head>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <!-- <td><?php echo $row['Book_id'];?></td> -->
                    ...
                    <td> <a href="rentdetail.php?b_id=<?php echo $row['book_id'];?>">
