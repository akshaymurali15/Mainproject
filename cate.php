...
$result=mysqli_query($conn,"SELECT * FROM `books` WHERE Type_id='$isd'");
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td> <a href="user_book_detail.php?b_id=<?php echo $row['Book_id'];?>">
                      <input type="button" class="btn btn-primary" style="margin-left:20px;" value="VIEW DETAILS">
                      </a></td>
                  </tr>
                  <?php } ?>
                  </tbody>
