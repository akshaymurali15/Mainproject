              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td> <a href="chat.php?b_id=<?php echo $row['Login_id'];?>">
                        <input type="button" class="btn btn-success" value="CHAT"></a>
                        <!-- <?php if ($row['Status'] == 'BLOCKED') { ?> -->
                    <!-- <a href="chat.php?a_id=<?php echo $row['Login_id'];?>>"><Button type="submit" class="btn btn-primary">ENABLE</Button></a>
                    <!-- <?php } else { ?>   -->
