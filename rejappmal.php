...
try {
   ...
   // $mail->addAttachment('/tmp/image.jpg', 'new.jpg');    //Optional name
    ...
    $mail->Subject = 'Succesfully Approved....!';
    $mail->Body    = 'Sorry for the inconvience Your Registration has been Succesfull, Admin approved you!!!!!!!  <b></b>';
   // $mail->AltBody = 'This is the body in plain text for non-HTML mail clients';

    $mail->send();
    echo 'Message has been sent';
    header("location:REJusers.php");
