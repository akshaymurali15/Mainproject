...
include 'db.php';
 ...
 if(isset($_POST['submit']))
 {
    ...
    $dup = mysqli_query($conn,"SELECT * FROM rentedbook WHERE book_name = '$name'");
  ...
  mysqli_query($conn,"INSERT INTO `rentedbook`(`book_name`, `Type_id`, `Rent_price`, `description`, `Image`,`Author_name`,`ISBN_no`,`Publisher`,`Pages`) VALUES ('$name','$cate','$pric','$stry','$fileName','$auth','$isb','$publ','$pg')");
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Add Books For Rent</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
