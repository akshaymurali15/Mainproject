...
$result=mysqli_query($conn,"SELECT distributor.*,login.* from distributor,login WHERE distributor.Login_id=login.Login_id and login.Login_id='$su_id'");
...
if(isset($_POST['submit']))
 {
    ...
    mysqli_query($conn, "UPDATE `distributor` SET `Name`='$name',`Mobile`='$phone',`Email`='$email',`Address`='$place' WHERE Login_id='$su_id'");
